...
<body class="background">
                ...
                <div class="table-responsive d-flex">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h2><b><?= $lang['model-brand-list'] ?></b></h2>
                                </div>
                                <div class="col-sm-4">
                                    <button type="button" class="btn btn-info add-new" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal"><i class="fa fa-plus"></i> <?= $lang['add-new'] ?></button>
                                </div>
                            </div>
                        </div>
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <tbody>
                                ...
                                foreach ($modelbrand as $key => $value) {
                                    ...
                                    echo '<button class="btn btn-warning btnEdit" data-bs-toggle="modal" data-bs-target="#editModal" id="' . $id . '" onClick="edit_brand(this.id)" value="' . $id . '" >' . $lang['edit'] . '</button>';
                                    echo '<button class="btn btn-danger btnDelete" data-bs-toggle="modal" data-bs-target="#deleteModal" id="' . $id . '" onClick="delete_brand(this.id)" value="' . $id . '"  >' . $lang['delete'] . '</button>';
                                    echo '</div>';
                                    echo '</div>';
                                    echo '</td>';
                                    echo '</tr>';
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="http://localhost/apirest-comparator/public/store-modelbrand" method="post" id="formulario">
                    <div class="modal-body">
                        <div class="w-600-disabled">
                            <input type="text" class="form-control mt-1 w-400" name="brand" id="idbrand" placeholder="Brand" />
    ...
    <div class="modal fade" id="editModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="http://localhost/apirest-comparator/public/update-modelbrand" method="post" id="formulario">
                    <div class="modal-body">
                        <div class="w-600-disabled">
                            <input type="text" class="form-control mt-1 w-400" name="brand" id="idbrand_name" placeholder="Brand" />
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-outline-dark btn-lg" name="id" id="id_send_brand" value="">
                            <?= $lang["send-data"] ?>
                        </button>
                    </div>
                </form>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="http://localhost/apirest-comparator/public/delete-modelbrand" method="post" id="formulario">
                    <div class="modal-body">
                        <div class="w-600-disabled">
                            <input type="text" class="form-control mt-1 w-400" name="id_mostrar_brand" placeholder="Brand" id="id_mostrar" disabled />
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-outline-dark btn-lg" name="id" id="id_send_brand_delete" value="">
                            <?= $lang["send-data"] ?>
                        </button>
                    </div>
                </form>
    ...
    <script src="{{ url('assets/js/brand.js') }}"></script>
