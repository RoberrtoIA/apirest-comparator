                        ...
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            <thead class="table-dark">
                                <tr>
                                    ...
                                    <th scope="col" width="80">CPU Model</th>
                                    <th scope="col" width="50">Score</th>
                                    <th scope="col" width="50">Speed</th>
                                    <th scope="col" width="50">Id CPU Brand</th>
                                    <th scope="col" width="70">Available</th>
                            ...
                            <tbody>
                                ...
                                foreach ($cpu as $key => $value) {
                                    ...
                                    echo '<button class="btn btn-warning btnEdit" data-bs-toggle="modal" data-bs-target="#editModal" id="'. $id. '" onClick="edit_cpu(this.id)" value="'. $id. '" >' . $lang['edit'] . '</button>';
                                    echo '<button class="btn btn-danger btnDelete" data-bs-toggle="modal" data-bs-target="#deleteModal" id="'. $id. '" onClick="delete_cpu(this.id)" value="'. $id. '"  >' . $lang['delete'] . '</button>';
                                    echo '</div>';
                                    echo '</div>';
                                    echo '</td>';
                                    echo '</tr>';
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="http://localhost/apirest-comparator/public/store-cpu" method="post" id="formulario">
                    <div class="modal-body">
                        <div class="w-600-disabled">
                            <input type="text" class="form-control mt-1 w-400" name="cpu" placeholder="CPU Model" />
                            <input type="number" class="form-control mt-1 w-400" name="score" placeholder="Score" />
                            <input type="text" class="form-control mt-1 w-400" name="speed" placeholder="Speed" />
                            <input type="number" class="form-control mt-1 w-400" name="idcpubrand"
                                placeholder="Id CPU Brand" />
                        </div>
                    </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="http://localhost/apirest-comparator/public/update-cpu" method="post" id="formulario">
                    <div class="modal-body">
                        <div class="w-600-disabled">
                            <input type="text" class="form-control mt-1 w-400" name="cpu" placeholder="CPU Model" id="idcpu" />
                            <input type="number" class="form-control mt-1 w-400" name="score" placeholder="Score" id="idscore" />
                            <input type="text" class="form-control mt-1 w-400" name="speed" placeholder="Speed" id="idspeed" />

                            <select class="form-select  mt-1 w-400" name="idcpubrand" aria-label="Default select example">
                            <?php
                            $array = [];
                            $id = null;
                            foreach ($cpubrand as $key => $value) {
                                array_push($array, $value);
                                foreach ($value as $key2 => $value2) {
                            ...
                            foreach ($array as $key => $value) {
                                echo '<option value="' . $value['idCPUBrand'] . '">' . $value['CPUBrand'] . '</option>';
                            }
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-outline-dark btn-lg" name="id" id="id_send_cpu" value="">
                            <?= $lang["send-data"] ?>
                        </button>
                    </div>
                </form>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="http://localhost/apirest-comparator/public/delete-cpu" method="post" id="formulario">
                    <div class="modal-body">
                        <div class="w-600-disabled">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-outline-dark btn-lg" name="id" id="id_send_cpu_delete" value="">
                            <?= $lang["send-data"] ?>
                        </button>
                    </div>
                </form>
